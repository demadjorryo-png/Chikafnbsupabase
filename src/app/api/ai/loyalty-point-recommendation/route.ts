...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const response = await fetch(`${supabaseUrl}/functions/v1/loyalty-point-recommendation-flow`, {
      method: 'POST',
      headers: {
    ...
    console.error('Error calling loyaltyPointRecommendationFlow Edge Function:', error);
