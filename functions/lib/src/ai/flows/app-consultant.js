...
exports.consultWithChika = void 0;
const genkit_1 = require("@/ai/genkit");
const genkit_2 = require("genkit");
const AppConsultantInputSchema = genkit_2.z.object({
    conversationHistory: genkit_2.z.string().describe('The history of the conversation so far.'),
    userInput: genkit_2.z.string().describe('The latest input from the user.'),
});
const AppConsultantOutputSchema = genkit_2.z.object({
    response: genkit_2.z.string().describe('Chika AI\'s response to the user.'),
    shouldEscalateToAdmin: genkit_2.z.boolean().describe('Set to true if the conversation has reached a summary/escalation point.'),
    escalationMessage: genkit_2.z.string().optional().describe('A concise summary message formatted for WhatsApp, to be sent to the admin group if shouldEscalateToAdmin is true.'),
});
exports.consultWithChika = genkit_1.ai.defineFlow({
...
//# sourceMappingURL=app-consultant.js.map